...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Jun 2023 05:42:48 GMT -->
<head>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            <li>
                                <a href="{{ route('category.add') }}" class="has-arrow" key="t-vertical">Add Category</a>
                            </li>

                            <li>
                                <a href="{{ route('category.manage') }}" class="has-arrow" key="t-horizontal">Manage Category</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-utility">Sub Category Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('sub-category.add') }}" key="t-starter-page">Add Sub Category</a></li>
                            <li><a href="{{ route('sub-category.manage') }}" key="t-maintenance">Manage Sub Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-ecommerce">Unit Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('unit.add') }}" key="t-products">Add Unit</a></li>
                            <li><a href="{{ route('unit.manage') }}" key="t-product-detail">Manage Unit</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-tables">Brand Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('brand.add') }}" key="t-basic-tables">Add Brand</a></li>
                            <li><a href="{{ route('brand.manage') }}" key="t-data-tables">Manage Brand</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('product.add') }}" key="t-p-grid">Add Product</a></li>
                            <li><a href="{{ route('product.manage') }}" key="t-p-list">Manage Product</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-invoices">Order Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('order.manage') }}" key="t-invoice-detail">Manage Order</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-contacts">Customer Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('customer.manage') }}" key="t-user-grid">Manage Customer</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-blog"> Company Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="blog-list.html" key="t-blog-list">Add Product</a></li>
                            <li><a href="blog-grid.html" key="t-blog-grid">Manage Product</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('user.add') }}" key="t-login">Add User</a></li>
                            <li><a href="{{ route('user.manage') }}" key="t-login-2">Manage User</a></li>
                        </ul>
                    </li>
                    @endif
                </ul>
...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Jun 2023 05:43:29 GMT -->
</html>
