                    ...
                    <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                        <div class="product-image">
                            <div class="product_img_box">
                                <img id="product_img" src="{{asset($product->image)}}" width="540" height="600" data-zoom-image="{{asset($product->image)}}" alt="product_img1" />
                                <a href="#product_img" class="product_img_zoom" title="Zoom">
                            ...
                            <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                               @foreach($product->OtherImages as $image)
                                <div class="item">
                                    <a href="#subImage" class="product_gallery_item active" data-image="{{asset($image->image)}}" data-zoom-image="{{asset($image->image)}}">
                                        <img src="{{asset($image->image)}}" width="100" id="subImage" height="100" alt="product_small_img1" />
                                    </a>
                                </div>
                                @endforeach
                            </div>
